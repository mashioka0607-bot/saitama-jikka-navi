...
body=f'''<section class="hero"><div class="eyebrow">Kawagoe / Inherited Home</div><h1>実家を片付ける前に、<br>家の出口を比べる。</h1><p class="lead">相続した実家や空き家は、残置物がある状態でも売却・活用・管理・解体の相談ができます。先に高額な片付けを契約せず、家の価値と出口を確認してから必要な片付けだけ進めます。</p><p><a class="button" href="/shindan/">3分で進め方を整理する</a></p></section><section class="section"><div class="facts"><div class="fact"><strong>1. 現況で出口確認</strong><br>残置物があるまま売却・活用・管理・解体を比較</div><div class="fact"><strong>2. 名義・相続を確認</strong><br>自治体の無料相談・登記相談など一次情報を確認</div><div class="fact"><strong>3. 必要分だけ片付け</strong><br>出口が決まってから処分・買取・業者比較へ</div></div></section><section class="section notice"><strong>川越市にも無料の空き家相談窓口があります</strong><p>川越市は、空き家・空き地について「何から手をつければいいか」から、相続・管理・賃貸・売却・解体まで宅地建物取引士に相談できる窓口を案内しています。まず公的な相談先を確認する選択肢もあります。</p><p><a href="https://www.city.kawagoe.saitama.jp/kurashi/jyutaku/1003031/1020433.html" target="_blank" rel="noopener">川越市公式の空き家・空き地相談を見る</a></p></section>{offer_cta('primary','home')}<section class="section"><h2>片付けが必要になったら確認すること</h2><div class="grid">{cards}</div></section><section class="section warning"><strong>処分を依頼する前に</strong><p>家庭の遺品整理で出る不用品は一般廃棄物です。川越市は自己搬入または対応可能な一般廃棄物収集運搬業許可業者への依頼を案内しています。</p><p><a href="https://www.city.kawagoe.saitama.jp/kurashi/gomi/1002380/1019544.html" target="_blank" rel="noopener">川越市公式案内</a></p></section>'''
write('index.html',layout('相続した実家を片付ける前に｜売却・活用・管理・解体を比較','川越市を中心に、相続した実家を片付ける前に売却・活用・管理・解体を比較。残置物がある状態から、自治体相談、相続・登記、必要な片付けの順番を整理します。',body,'/'))
